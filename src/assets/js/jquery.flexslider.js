            ...
            directionNav: {
                setup: function() {
                  /*  var directionNavScaffold = jQuery('<ul class="' + namespace + 'direction-nav"><li><a class="' + namespace + 'prev" href="#">' + slider.vars.prevText + '</a></li><li><a class="' + namespace + 'next" href="#">' + slider.vars.nextText + '</a></li></ul>');*/
                    ...
                    var directionNavScaffold = jQuery('<ul class="' + namespace + 'direction-nav"><li><a class="' + namespace + 'prev">' + slider.vars.prevText + '</a></li><li><a class="' + namespace + 'next" >' + slider.vars.nextText + '</a></li></ul>');
