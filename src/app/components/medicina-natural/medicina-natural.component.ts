...
@Component({
  selector: 'app-medicina-natural',
  templateUrl: './medicina-natural.component.html',
  styleUrls: ['./medicina-natural.component.css']
})
export class MedicinaNaturalComponent implements OnInit {
  ...
  constructor(private producto:ProductoService , private cartService: CarritoService , private globals: Globals , public moneda: MonedaService , public loginservice: LoginService) { 

    this.moneda.listarMoneda().subscribe(response => {
      this.listaMoneda= response;


      this.producto.listarProductoNatural().subscribe(response => {
